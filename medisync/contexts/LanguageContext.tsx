...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    primaryContactNamePlaceholder: 'e.g. Mom, Ravi Sharma',
    primaryEmergencyContact: 'Primary emergency contact',
    secondaryContactName: 'Secondary contact name',
    secondaryContactNamePlaceholder: 'e.g. Dad, Priya Patel',
  ...
  hi: {
    ...
    primaryContactNamePlaceholder: 'जैसे माँ, Ravi Sharma',
    primaryEmergencyContact: 'प्राथमिक आपातकालीन संपर्क',
    secondaryContactName: 'द्वितीय संपर्क का नाम',
    secondaryContactNamePlaceholder: 'जैसे पापा, Priya Patel',
