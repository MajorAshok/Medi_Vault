    ...
    return (
        <main className="flex h-screen flex-col overflow-hidden px-6 py-6 md:px-10 md:py-8">
            <style>{`
                ...
                .animate-ring-spin { animation: ringSpin 2.2s linear infinite; }
            `}</style>
                                    ...
                                    <div className="mt-6 border-t border-white/10 pt-4">
                                        ...
                                        <div className="animate-fade-in-up mt-2 flex flex-col gap-3">
                                            ...
                                            <button
                                                ...
                                                className="mt-2 w-fit rounded-xl bg-pink-600 px-4 py-2 text-sm font-semibold text-white disabled:opacity-50 transition hover:opacity-90"
                                            >
