...
function Md({ text }: { text: string }) {
    return (
        <div className="font-sans text-[13.5px] leading-relaxed text-foreground/90">
            <ReactMarkdown
                components={{
                    p: ({ children }: { children?: React.ReactNode }) => <p className="mt-2 first:mt-0">{children}</p>,
                    strong: ({ children }: { children?: React.ReactNode }) => <strong className="font-semibold text-foreground">{children}</strong>,
                    em: ({ children }: { children?: React.ReactNode }) => <em className="italic">{children}</em>,
                    h1: ({ children }: { children?: React.ReactNode }) => <h1 className="mt-4 mb-1 text-base font-semibold text-foreground">{children}</h1>,
                    h2: ({ children }: { children?: React.ReactNode }) => <h2 className="mt-4 mb-1 text-[15px] font-semibold text-foreground">{children}</h2>,
                    h3: ({ children }: { children?: React.ReactNode }) => <h3 className="mt-4 mb-1 text-sm font-semibold text-foreground">{children}</h3>,
                    ul: ({ children }: { children?: React.ReactNode }) => <ul className="mt-2 list-disc space-y-1 pl-5">{children}</ul>,
                    ol: ({ children }: { children?: React.ReactNode }) => <ol className="mt-2 list-decimal space-y-1 pl-5">{children}</ol>,
