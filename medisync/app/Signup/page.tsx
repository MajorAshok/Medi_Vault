...
const signupText = {
  en: {
    createFreeAccount: 'Create your\nFree Account',
    tagline: 'STORE YOUR MEDICAL RECORDS AND GET EMERGENCY-READY.',
    signUp: 'Sign up',
    ...
    errorPrefix: 'Error',
    successMessage:
      '✅ Signed up! Check your email to confirm, or check Supabase Auth users list.',
  },
  hi: {
    createFreeAccount: 'अपना\nमुफ्त खाता बनाएँ',
    tagline: 'अपने मेडिकल रिकॉर्ड सुरक्षित रखें और आपात स्थिति के लिए तैयार रहें।',
    signUp: 'साइन अप',
    ...
    errorPrefix: 'त्रुटि',
    successMessage:
      '✅ साइन अप हो गया! पुष्टि के लिए अपना ईमेल देखें, या Supabase Auth users list चेक करें।',
  },
}

export default function SignUp() {
  const { language } = useLanguage()
  const text = signupText[language]
  ...
  async function handleSignUp() {
    ...
    if (error) {
      setMessage(`${text.errorPrefix}: ${error.message}`)
    } else {
    ...
    <main className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:block relative w-1/2 overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-center px-14 max-w-xl">
          <h1 className="font-heading text-6xl font-extrabold text-white leading-[1.05] drop-shadow-lg whitespace-pre-line">
          ...
          <div className="mt-8 -ml-3 inline-block float-card backdrop-blur-xl bg-black/45 border border-white/20 p-8 max-w-[420px] rounded-[2.5rem] shadow-[0_16px_40px_rgba(0,0,0,0.45)] ring-1 ring-white/15">
            <p
              ...
              style={{
                ...
                letterSpacing: language === 'hi' ? '0.05em' : '0.3em',
                lineHeight: 1.6,
